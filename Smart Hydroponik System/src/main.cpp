...
unsigned long lastPrintTime = 0; // Last data display time
...
// volatile long pulseCount = 0;  // Variable to count pulses from the sensor
// const float flowFactor = 4.8;  // Flow meter constant (pulses per liter)
...
volatile int receivedFlowRate = 0; // Variable to store received data
